      ...
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-4 py-4 sm:px-6 lg:px-8">
        ...
        <div className="flex items-center gap-3">
          <NavLink
            to="/signin"
            className={({ isActive }) =>
              `hidden rounded-full px-5 py-2.5 text-sm font-semibold transition md:inline-flex ${
                isActive
          ...
          <div ref={cartRef} className="relative">
            ...
            {isCartOpen && (
              <div className="fixed left-4 right-4 top-20 z-50 sm:absolute sm:left-auto sm:right-0 sm:top-full sm:mt-4 sm:w-[390px] bg-white/90 backdrop-blur-xl ">
                ...
                {cart.length === 0 ? (
                  ...
                  <>
                    ...
                    <div className="border-t border-slate-100 px-5 py-4">
                      ...
                      <Link
                        to="/cart"
                        className="block rounded-full bg-blue-600 px-4 py-3 text-center text-sm font-bold text-white shadow-lg shadow-blue-600/20 transition hover:bg-blue-700 active:scale-95"
                      >
                        View Cart
                      </Link>
                    </div>
